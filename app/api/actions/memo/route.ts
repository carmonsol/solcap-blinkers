...
/**
 * SOLCAP - Blinkers - Blinks Actions Example 1: Memo
 */
...
import {
  ...
  export const GET = async (req: Request) => {
    const payload: ActionGetResponse = {
      title: "SOLCAP - Blinks Example 1 (Memo Blinks)",
      icon: new URL("https://shdw-drive.genesysgo.net/987A8x5JVEZGet9yvTV9AuNgj7NGyhhxQBSYeVCcoW7C/solana-devs9.jpg",
  ...
  try {
    ...
    const transaction = new Transaction().add(
      ...
      new TransactionInstruction({
        ...
        data: Buffer.from(
          "this is a simple memo message from SOLCAP - BLinkers",
          "utf8"
        ),
        keys: [],
      })
